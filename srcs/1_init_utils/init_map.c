...
/*   Updated: 2024/05/27 19:43:25 by janhan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_map(t_game *game, int ac, char **av)
{
	...
	game->map_len_w = game->parse.row;
	game->map_len_h = game->parse.col;
	game->map_width = game->parse.row * MINI_MAP_PIXEL;
	game->map_height = game->parse.col * MINI_MAP_PIXEL;
