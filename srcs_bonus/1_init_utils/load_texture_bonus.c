...
static void	load_menu_texture_sub(t_game *game)
{
	...
	game->exit_game_n = make_xpm_img(game, "resources/textures/Exit_game_n.xpm");
	game->exit_game_h = make_xpm_img(game, "resources/textures/Exit_game_h.xpm");
}
...
static void	load_menu_texture(t_game *game)
{
	...
	game->main_menu = make_xpm_img(game, "resources/textures/klipartz.com.xpm");
	game->main_background = make_xpm_img(game, "resources/textures/main_background.xpm");
	game->start_n = make_xpm_img(game, "resources/textures/Start_n.xpm");
...
static void	load_wall_texture(t_game *game, t_img *tmp)
{
	...
	tmp[EAST] = make_png_img_nomalloc(game, game->parse.tex[0].tex_path);
	tmp[NORTH] = make_png_img_nomalloc(game, game->parse.tex[1].tex_path);
	tmp[WEST] = make_png_img_nomalloc(game, game->parse.tex[2].tex_path);
	tmp[SOUTH] = make_png_img_nomalloc(game, game->parse.tex[3].tex_path);
}
